                    ...
                    <div class="login-side w-100">
                        <div class="position-relative" style="z-index: 1;">
                            ...
                            <p class="lead mb-5" style="opacity: .88;">
                                Customers manage recurring boxes here, and admins can sign in to
                                review orders, returns, inventory, and themes.
                            </p>
                    ...
                    <div class="login-form-box">
                        ...
                        <form method="POST" action="{{ route('login.submit') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="btn-group w-100" role="group" aria-label="Account type">
                                    <input type="radio" class="btn-check" name="account_type"
                                        id="login-as-customer" value="customer" autocomplete="off"
                                        {{ old('account_type', 'customer') === 'customer' ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary py-2" for="login-as-customer">
                                        <i class="bi bi-person me-1"></i>Customer
                                    </label>

                                    <input type="radio" class="btn-check" name="account_type"
                                        id="login-as-admin" value="admin" autocomplete="off"
                                        {{ old('account_type') === 'admin' ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary py-2" for="login-as-admin">
                            ...
                            <div class="form-check mb-4">
                                ...
                                <label class="form-check-label text-muted small" for="remember-check">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('register') }}"
                                class="text-primary fw-semibold small text-decoration-none"> Create one</a>
                        </div>
