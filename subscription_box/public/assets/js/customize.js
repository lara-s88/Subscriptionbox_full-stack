...
// Mock box data
const boxes = {
    1: { title: 'Box', type: 'Clothing', image: 'https://images.pexels.com/photos/2294361/pexels-photo-2294361.jpeg?auto=compress&cs=tinysrgb&w=800', price: 49.99, items: ['Jersey (M)', 'Training Shorts', 'Socks', 'Cap'] },
...
// ======================================
// SPORTBOX PREFERENCES DYNAMIC SYSTEM
// ======================================
...
function updateSummary() {
    ...
    document.getElementById("summary-size")
        .innerText = selectedData.size;

    document.getElementById("summary-diet")
        .innerText = selectedData.diet;

    document.getElementById("summary-delivery")
        .innerText = selectedData.delivery;
}